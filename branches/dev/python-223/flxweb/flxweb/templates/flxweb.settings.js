...
define('flxweb.settings', ['jquery'], function ($) {
    $.flxweb = $.flxweb || {};
    var settings = {
        ...
        'tinymce': {
            ...
            'script4_url': '{{ c.tinymce4_script_url }}',
            'default_plugins': '{{ c.tinymce_default_plugins}}',
            'default_plugins4': '{{ c.tinymce4_default_plugins}}',
            'ck12_plugins': "{{ c.tinymce_ck12_plugins }}",
            'ck12_plugins4': "{{ c.tinymce4_ck12_plugins }}",
            'create_exercise_plugins': "{{ c.tinymce_create_exercise_plugins }}",
            'ck12_plugins_url': '{{ c.tinymce_ck12_plugins_url }}',
            'ck12_plugins4_url': '{{ c.tinymce4_ck12_plugins_url }}',
        },
