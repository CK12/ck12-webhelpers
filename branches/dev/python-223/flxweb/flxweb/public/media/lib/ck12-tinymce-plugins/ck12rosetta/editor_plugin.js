            ...
            ed.onPreInit.add(function() {
                ...
                ed.parser.addNodeFilter('ol', function(nodes) {
                    ...
                    while(i--) {
                        ...
                        if(nodeclass.indexOf('x-ck12-') !== -1) {
                            ...
                            node.attr('data-ck12-ol-class',nodeclass);
                ...
                ed.serializer.addNodeFilter('ol', function(nodes, name, args) {
                    ...
                    while(i--) {
                        ...
                        if(nodeclass.indexOf('x-ck12-') === -1) {
                            var nodeclass = node.attr('data-ck12-ol-class') || '';
                            var nodestyle = node.attr('style') || '';

                            if(nodestyle.indexOf('lower-alpha') !== -1 && nodeclass.indexOf('lower-alpha') === -1 ) {
                                nodeclass += ' x-ck12-lower-alpha';

                            } else if(nodestyle.indexOf('upper-alpha') !== -1 && nodeclass.indexOf('upper-alpha') === -1) {
                                nodeclass += ' x-ck12-upper-alpha';

                            } else if(nodestyle.indexOf('lower-roman') !== -1 && nodeclass.indexOf('lower-roman') === -1) {
                                nodeclass += ' x-ck12-lower-roman';

                            } else if(nodestyle.indexOf('upper-roman') !== -1 && nodeclass.indexOf('upper-roman') === -1) {
                                nodeclass += ' x-ck12-upper-roman';
                            }
                            node.attr('class', nodeclass);
                            node.attr('data-ck12-ol-class',null);
