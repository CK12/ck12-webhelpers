 ...
 * it's initialized.
 */
tinymce.PluginManager.add('ck12autoresize', function(editor) {
    'use strict';
    var settings = editor.settings, oldSize = 0, t = this;

    function isFullscreen() {
        var fullscreen = editor.plugins.ck12fullscreen || editor.plugins.fullscreen;
        return fullscreen && fullscreen.isFullscreen();
    }
    ...
    function resize(e) {
        ...
        if (!body || isFullscreen() || (e && e.type === 'setcontent' && e.initial)) {
            if (body && docElm) {
