module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		eslint: {
			...
			ck12plugins: [
				"../ck12-tinymce-plugins/**/plugin.js",
				"!../ck12-tinymce-plugins/**/plugin.min.js"
			],
		...
		jscs: {
			...
			ck12plugins: [
				"../ck12-tinymce-plugins/**/plugin.js",
				"../ck12-tinymce-plugins/**/tests/test.js",
				"!../ck12-tinymce-plugins/**/plugin.min.js"
			],
		...
		skin: {
			modern: {
				options: {
					...
					path: "js/tinymce/skins/lightgray/.",
					dest: "js/tinymce/skins/lightgray/.",
					ext: ".modern.dev.less",
                    srcLess: "skin.less",
			...
			ck12modern: {
				options: {
					...
					append: ["Icons.less", "CK12.Assessment.less"],
					importFrom: "js/tinymce/tinymce.js",
					path: "js/tinymce/skins/ck12lightgray/.",
					dest: "js/tinymce/skins/ck12lightgray/.",
					ext: ".ck12modern.dev.less",
                    srcLess: "skin.ck12modern.less",
                    devLess: "skin.ck12modern.dev.less"
				}
			},
		...
		less: {
			modern: {
				...
				expand: true,
				src: ["js/tinymce/skins/lightgray/skin.modern.dev.less"],
				ext: ".min.css"
			},
			...
			ck12modern: {
				...
				expand: true,
				src: ["js/tinymce/skins/ck12lightgray/skin.ck12modern.dev.less"],
				ext: ".min.css"
			},
		...
		uglify: {
			...
			themes: {
				src: ["js/tinymce/themes/modern/theme.js"],
				expand: true,
				ext: ".min.js"
			},
			...
			ck12modern: {
				expand: true,
				src: ["js/tinymce/themes/ck12modern/theme.js"],
				ext: ".min.js"
			},
			...
			ck12plugins: {
      			files: [{
	                expand: true,
	                cwd: '../ck12-tinymce4-plugins/',
	                src: ['**/plugin.js'],
	                dest: '../ck12-tinymce4-plugins/',
	                ext: '.min.js'
            	}],
			},
		...
		watch: {
			...
			ck12plugins: {
				files: ["../ck12-tinymce-plugins/**/*_src.js"],
				tasks: [
					// "eslint:ck12plugins", "jshint:ck12plugins", "jscs:ck12plugins",
					"uglify:ck12plugins"
				],
				options: {
					spawn: false
			...
			ck12plugins_tests: {
				files: [
					"../ck12-tinymce4-plugins/**/tests/test.js",
					"tests/ck12plugins/index.html"
				],
				tasks: [
					"qunit:ck12plugins"
		...
		open: {
			ck12plugins_tests: {
				file: "tests/ck12plugins/index.html"
			}
		}
	});
	...
	grunt.registerTask("minify", ["amdlc", "uglify", "skin:modern", "skin:ie7", "less"]);
	grunt.registerTask("ck12-skin", ["skin:ck12modern", "skin:ie7"]);
	grunt.registerTask("ck12-minify", ["amdlc", "uglify", "ck12-skin", "less"]);
