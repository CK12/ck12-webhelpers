        ...
        function cleanupStylesWhenDeleting(ed) {
                ...
                function removeMergedFormatSpans(isDelete) {
                    ...
                    function isAtStartOrEndOfElm() {
                        if (container.nodeType == 3 || container.nodeType == 1) {
                            if (isDelete && (offset == container.length || !container.length)) {
                                return true;
                            }
                ...
                ed.onKeyDown.add(function(ed, e) {
                    ...
                    if (!e.defaultPrevented && (isDelete || e.keyCode == BACKSPACE)) {
                        e.preventDefault();
                        removeMergedFormatSpans(isDelete);
                    }
                });

                ed.addCommand('Delete', function() {removeMergedFormatSpans();});
            };
