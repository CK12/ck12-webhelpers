    ...
    tinymce.create('tinymce.plugins.MathImagePlugin', {
        init: function (ed, url) {
            ...
            if(ed.settings.ck12_plugins_url){
                url = ed.settings.ck12_plugins_url + 'mathimage';
            }
            ed.addCommand('mceMathImage', function () {
                ...
                if (e.nodeName == 'IMG' && ((ed.dom.getAttrib(e, 'class').indexOf('mceItem') != -1) || 
                   ((ed.dom.getAttrib(e, 'class').indexOf('x-ck12-block-math') == -1) && (ed.dom.getAttrib(e, 'class').indexOf('x-ck12-math') == -1) && (ed.dom.getAttrib(e, 'class').indexOf('x-ck12-hwpmath') == -1) )))
                    return;
                ed.windowManager.open({
                    ...
                    plugin_url: url,
                    exercise_mode: isExerciseEditor(ed),		
                });
            });
            ...
            function isMathImage(n) {
                return /^(x-ck12-block-math|x-ck12-math|x-ck12-hwpmath)$/.test(n.className);
            }
...
function isExerciseEditor(ed) {
    if(ed && ed.getBody()) {
          var body_class = ed.getBody().className;
          if (body_class.search(/exeditor/i) >= 0) {
              return true;
          }
    }
    return false;
