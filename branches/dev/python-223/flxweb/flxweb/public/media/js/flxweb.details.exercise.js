...
(function ($) {
    ...
    function gobtn_click() {
        ...
        if (jsondata['answer'] === "") {
            ...
            $('#assessor_area').text('Please provide an answer');
            return;
        }
        $("#exercisebtnwrap .go_btn").unbind('click');
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.isCorrect) {
                    $('#assessor_area').html('<span class="imgwrap correct"></span>'+ result.resultMessage);
                    ...
                    $('#assessor_area').html('<span class="imgwrap wrong"></span>'+ result.resultMessage);
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                $('#assessor_area').addClass('empty');
                $('#assessor_area').html("Sorry, we are unable to evaluate your answer now. Please try again later.");
                $("#exercisebtnwrap .go_btn").click(gobtn_click);
                toggle_btn("#exercisebtnwrap .go_btn", 'show');
            }
        });
