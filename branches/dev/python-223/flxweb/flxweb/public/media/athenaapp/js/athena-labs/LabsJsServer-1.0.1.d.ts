...
declare module Labs.Core {
    ...
    */
    interface ILabHost {
        ...
        */
        disconnect(completionStatus: Core.ICompletionStatus, callback: Core.ILabCallback<void>);
        /**
...
declare module Labs {
    ...
    */
    class LabInstance {
        ...
        */
        constructor(labsInternal: Labs.LabsInternal, components: Labs.ComponentInstanceBase[], doneCallback: Function);
        /**
...
declare module Labs {
    ...
    */
    function disconnect(completionStatus: Core.ICompletionStatus): void;
    /**
...
declare module Labs {
    ...
    */
    class LabsInternal {
        ...
        */
        public dispose(completionStatus: Labs.Core.ICompletionStatus): void;
        /**
...
declare module Labs {
    ...
    */
    class ValueHolder<T> {
        ...
        */
        constructor(attemptId: string, id: string, labs: Labs.LabsInternal, isHint: boolean, hasBeenRequested: boolean, hasValue: boolean, value?: T);
        /**
...
declare module Labs.Components {
    class ActivityComponentAttempt {
        private _id;
        private _labs;
        private _resumed;
        private _state;
        ...
        */
        constructor(labs: Labs.LabsInternal, attemptId: string, values: {
...
declare module Labs {
    ...
    */
    interface IMessageHandler {
        (data: any, callback: Labs.Core.ILabCallback<any>): void;
    }
    class MessageProcessor {
        ...
        public messageMap: {
            [key: number]: Labs.Core.ILabCallback<any>;
        };
        public targetOrigin: string;
        public messageHandler: IMessageHandler;
        private _labId;
        constructor(labId: string, targetWindow: Window, targetOrigin: string, messageHandler: IMessageHandler);
        ...
        public start(): void;
        public stop(): void;
        public sendMessage(data: any, callback: Labs.Core.ILabCallback<any>): void;
    }
}
declare module Labs.Core {
    /**
...
declare module Labs {
    class InMemoryLabHost implements Labs.Core.ILabHost {
        ...
        public disconnect(completionStatus: Labs.Core.ICompletionStatus, callback: Labs.Core.ILabCallback<void>): void;
...
declare module Labs {
    class InMemoryLabState {
        ...
        private getComponentInstanceFromComponent(component, index);
        ...
        private findConfigurationValue(attemptId, valueId);
...
declare module LabsServer {
    class LabHost {
        ...
        private _processor;
        private _appId;
        constructor(appId: string, processor: LabsServer.ILabEventProcessor);
