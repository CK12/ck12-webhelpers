/*! LabsJsServer.js - v1.0.2 - 2014-03-28 */
var Labs;
(function (Labs) {
    (function (Core) {
        ;
...
(function (Labs) {
    var InMemoryLabState = (function () {
        ...
        InMemoryLabState.prototype.findConfigurationValue = function (componentId, attemptId, valueId) {
            for (var i = 0; i < this._configurationInstance.components.length; i++) {
                var component = this._configurationInstance.components[i];
                if (component.componentId === componentId) {
                    for (var key in component.values) {
                        var values = component.values[key];
                        for (var i = 0; i < values.length; i++) {
