...
members[0]=[32]; 
members[1]=[44, 45, 14, 18, 119]; 
members[2]=[32, 11, 34, 31, 95]; 
members[3]=[97, 21, 22]; 
members[4]=[72]; 
members[5]=[7, 113, 51, 22, 120]; 
members[6]=[38, 11, 86]; 
members[7]=[5, 113, 51, 120, 26]; 
members[8]=[41, 117]; 
members[9]=[34, 83, 85]; 
members[10]=[56, 41, 17]; 
members[11]=[32, 2, 6, 38, 34, 86, 31, 95]; 
members[12]=[52, 62, 116]; 
members[13]=[74, 43, 111, 81, 114, 117, 30]; 
members[14]=[1, 44, 45, 18, 119]; 
members[15]=[88, 98]; 
members[16]=[96, 123, 23]; 
members[17]=[56, 41, 10]; 
members[18]=[1, 44, 45, 14, 119]; 
members[19]=[58, 93, 118]; 
members[20]=[33, 122, 50, 55]; 
members[21]=[97, 3, 22]; 
members[22]=[97, 3, 21, 5]; 
members[23]=[16, 25, 96]; 
members[24]=[84]; 
members[25]=[104, 121, 92, 23]; 
members[26]=[60, 7]; 
members[27]=[61, 95]; 
members[28]=[57, 36, 30]; 
members[29]=[73, 110]; 
members[30]=[74, 13, 81, 114, 117, 28]; 
members[31]=[32, 2, 11, 76, 34, 95]; 
members[32]=[0, 2, 11, 34, 31, 95]; 
members[33]=[50, 20, 53, 55]; 
members[34]=[32, 2, 9, 11, 85, 31, 95]; 
members[35]=[39, 106, 76, 78, 79, 82, 53]; 
members[36]=[123, 28, 57]; 
members[37]=[124]; 
members[38]=[11, 6, 86]; 
members[39]=[35, 106, 76, 78, 79, 82, 87]; 
members[40]=[42, 125]; 
members[41]=[56, 17, 10, 8]; 
members[42]=[40, 101, 109]; 
members[43]=[13, 111]; 
members[44]=[1, 45, 14, 18, 119]; 
members[45]=[1, 67, 44, 14, 18, 119]; 
members[46]=[120, 89]; 
members[47]=[69, 54]; 
members[48]=[96, 98]; 
members[49]=[113, 107]; 
members[50]=[33, 122, 20, 55]; 
members[51]=[64, 5, 7, 113, 120]; 
members[52]=[12, 62, 116]; 
members[53]=[33, 35]; 
members[54]=[125, 47]; 
members[55]=[33, 122, 20, 50]; 
members[56]=[41, 10, 17]; 
members[57]=[36, 123, 28]; 
members[58]=[19, 93]; 
members[59]=[61]; 
members[60]=[26]; 
members[61]=[27, 59]; 
members[62]=[12, 52, 116, 81]; 
members[63]=[65, 100, 71]; 
members[64]=[51, 91, 108]; 
members[65]=[63, 100, 71]; 
members[66]=[99, 115, 70]; 
members[67]=[114, 68, 45]; 
members[68]=[114, 67]; 
members[69]=[72, 47]; 
members[70]=[115, 99, 66, 75]; 
members[71]=[65, 63, 100]; 
members[72]=[4, 69]; 
members[73]=[29, 110]; 
members[74]=[105, 13, 80, 81, 114, 117, 30]; 
members[75]=[70]; 
members[76]=[35, 39, 106, 78, 79, 82, 31]; 
members[77]=[112, 87]; 
members[78]=[35, 39, 106, 76, 79, 82, 90]; 
members[79]=[35, 101, 39, 105, 106, 76, 78, 82]; 
members[80]=[105, 74]; 
members[81]=[74, 62, 13, 114, 117, 30]; 
members[82]=[35, 100, 102, 39, 106, 76, 78, 79]; 
members[83]=[9, 124]; 
members[84]=[24, 103]; 
members[85]=[9, 34, 124]; 
members[86]=[38, 11, 6]; 
members[87]=[112, 77, 39]; 
members[88]=[98, 15]; 
members[89]=[120, 46]; 
members[90]=[107, 78]; 
members[91]=[64, 108]; 
members[92]=[104, 25, 121]; 
members[93]=[58, 19]; 
members[94]=[106, 103]; 
members[95]=[32, 34, 31, 11, 2, 27]; 
members[96]=[48, 16, 98, 23]; 
members[97]=[3, 21, 22]; 
members[98]=[88, 96, 48, 15]; 
members[99]=[66, 115, 70]; 
members[100]=[65, 102, 71, 82, 63]; 
members[101]=[105, 42, 109, 79]; 
members[102]=[82, 100, 110]; 
members[103]=[84, 94]; 
members[104]=[25, 92, 121]; 
members[105]=[80, 74, 101, 79]; 
members[106]=[35, 39, 76, 78, 79, 82, 94]; 
members[107]=[113, 90, 49]; 
members[108]=[64, 91]; 
members[109]=[42, 125, 101]; 
members[110]=[73, 29, 102]; 
members[111]=[43, 13]; 
members[112]=[77, 87]; 
members[113]=[5, 7, 107, 51, 120, 49]; 
members[114]=[67, 68, 74, 13, 81, 117, 30]; 
members[115]=[66, 99, 70, 118, 122]; 
members[116]=[12, 52, 62]; 
members[117]=[8, 74, 13, 81, 114, 30]; 
members[118]=[115, 122, 19]; 
members[119]=[1, 44, 45, 14, 18]; 
members[120]=[5, 7, 46, 113, 51, 89]; 
members[121]=[104, 25, 92]; 
members[122]=[50, 115, 20, 118, 55]; 
members[123]=[16, 57, 36]; 
members[124]=[83, 37, 85]; 
members[125]=[40, 54, 109]; 
...
paper.setStart(); 
t=paper.text(nx[0],ny[0]-10,'Recent Space Exploration').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[0]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Recent-Space-Exploration/#Recent Space Exploration", target: "_top"});
}); 
...
paper.setStart(); 
t=paper.text(nx[1],ny[1]-10,'Wave Erosion and\nDeposition').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[1]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Wave-Erosion-and-Deposition/#Wave Erosion and Deposition", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[2],ny[2]-10,'Telescopes').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[2]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Telescopes/#Telescopes", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[3],ny[3]-10,'Water Pollution').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[3]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Water-Pollution/#Water Pollution", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[4],ny[4]-10,"History of Earth's Complex\nLife Forms").attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[4]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/History-of-Earth’s-Complex-Life-Forms/#History of Earth's Complex Life Forms", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[5],ny[5],"Human Actions and Earth's\nWaters").attr({fill:"#666666","font-size": 14*sfac[5]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[6],ny[6]-10,'Inner Planets').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[6]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Inner-Planets/#Inner Planets", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[7],ny[7],"Human Actions and Earth's\nResources").attr({fill:"#666666","font-size": 14*sfac[7]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[8],ny[8]-10,'Matter Matters').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[8]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Matter-Matters/#Matter Matters", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[9],ny[9]-10,'Planet Earth').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[9]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Planet-Earth/#Planet Earth", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[10],ny[10]-10,'Mining and Mineral Use').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[10]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Mining-and-Mineral-Use/#Mining and Mineral Use", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[11],ny[11],'The Solar System').attr({fill:"#666666","font-size": 14*sfac[11]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[12],ny[12]-10,'Metamorphic Rocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[12]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Metamorphic-Rocks/#Metamorphic Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[13],ny[13]-10,"Modeling the Earth's\nSurface").attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[13]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Modeling-Earth’s-Surface/#Modeling the Earth's Surface", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[14],ny[14]-10,'Wind Erosion and\nDeposition').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[14]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Wind-Erosion-and-Deposition/#Wind Erosion and Deposition", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[15],ny[15]-10,'Types of Volcanoes').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[15]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Types-of-Volcanoes/#Types of Volcanoes", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[16],ny[16]-10,'Theory of Plate Tectonics').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[16]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Theory-of-Plate-Tectonics/#Theory of Plate Tectonics", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[17],ny[17]-10,'Mineral Identification').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[17]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Mineral-Identification/#Mineral Identification", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[18],ny[18]-10,'Water Erosion and\nDeposition').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[18]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Water-Erosion-and-Deposition/#Water Erosion and Deposition", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[19],ny[19]-10,'Climate and its Causes').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[19]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Climate-and-Its-Causes/#Climate and its Causes", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[20],ny[20]-10,'Energy in the Atmosphere').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[20]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Energy-in-the-Atmosphere/#Energy in the Atmosphere", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[21],ny[21]-10,'Problems with Water\nDistribution').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[21]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Problems-with-Water-Distribution/#Problems with Water Distribution", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[22],ny[22]-10,'Humans and the Water\nSupply').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[22]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Humans-and-the-Water-Supply/#Humans and the Water Supply", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[23],ny[23],'Earthquakes').attr({fill:"#666666","font-size": 14*sfac[23]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[24],ny[24],'Earth Science').attr({fill:"#000000","font-size": 24*sfac[24]});
tBox=t.getBBox(); 
...
rect=paper.rect(bl[24], bt[24], br[24]-bl[24], bb[24]-bt[24], 10*sfac[24]).attr({stroke:"#7cbf00","stroke-width": "4",fill:"black","fill-opacity":"0"});
b[24]=paper.setFinish(); 

paper.setStart(); 
t=paper.text(nx[25],ny[25],"Stress in the Earth's Crust").attr({fill:"#666666","font-size": 14*sfac[25]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[26],ny[26]-10,'Use and Conservation\nof Resources').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[26]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Use-and-Conservation-of-Resources/#Use and Conservation of Resources", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[27],ny[27]-10,'Stars').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[27]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Stars/#Stars", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[28],ny[28]-10,'Inside Earth').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[28]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Inside-Earth/#Inside Earth", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[29],ny[29]-10,'Surface Water').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[29]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Surface-Water/#Surface Water", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[30],ny[30],'Plate Tectonics').attr({fill:"#666666","font-size": 14*sfac[30]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[31],ny[31],'Obesrving and Exploring Space').attr({fill:"#666666","font-size": 14*sfac[31]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[32],ny[32]-10,'Early Space Exploration').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[32]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Early-Space-Exploration/#Early Space Exploration", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[33],ny[33]-10,'The Atmosphere').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[33]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Atmosphere/#The Atmosphere", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[34],ny[34],'Earth, Moon, and Sun').attr({fill:"#666666","font-size": 14*sfac[34]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[35],ny[35]-10,'Climatology and\nMeteorology').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[35]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Climatology and Meteorology", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[36],ny[36]-10,'Continental Drift').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[36]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Continental-Drift/#Continental Drift", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[37],ny[37]-10,'The Sun and the\nEarth-Moon System').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[37]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Sun-and-the-Earth-Moon-System/#The Sun and the Earth-Moon System", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[38],ny[38]-10,'Other Objects in the\nSolar System').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[38]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Other-Objects-in-the-Solar-System/#Other Objects in the Solar System", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[39],ny[39],"Earth's Energy").attr({fill:"#666666","font-size": 14*sfac[39]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[40],ny[40]-10,'Absolute Ages of\nRocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[40]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Absolute-Ages-of-Rocks/#Absolute Ages of Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[41],ny[41]-10,'Minerals and Mineral\nGroups').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[41]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Minerals-and-Mineral-Groups/#Minerals and Mineral Groups", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[42],ny[42]-10,'Relative Ages of\nRocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[42]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Relative-Ages-of-Rocks/#Relative Ages of Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[43],ny[43]-10,'Topographic Maps').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[43]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Topographic-Maps/#Topographic Maps", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[44],ny[44]-10,'Glacial Erosion and\nDeposition').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[44]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Glacial-Erosion-and-Deposition/#Glacial Erosion and Deposition", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[45],ny[45],'Erosion and Deposition').attr({fill:"#666666","font-size": 14*sfac[45]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[46],ny[46]-10,'Loss of Soils').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[46]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Loss-of-Soils/#Loss of Soils", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[47],ny[47]-10,'Early Earth').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[47]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Early-Earth/#Early Earth", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[48],ny[48],'Where Volcanos Occur').attr({fill:"#666666","font-size": 14*sfac[48]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[49],ny[49]-10,'The Carbon Cycle and the\nNitrogen Cycle').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[49]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Carbon-Cycle-and-the-Nitrogen-Cycle/#The Carbon Cycle and the Nitrogen Cycle", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[50],ny[50]-10,'Atmospheric Layers').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[50]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Atmospheric-Layers/#Atmospheric Layers", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[51],ny[51],'Human Actions and the\nAtmosphere').attr({fill:"#666666","font-size": 14*sfac[51]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[52],ny[52]-10,'Igneous Rocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[52]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Igneous-Rocks/#Igneous Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[53],ny[53],"Earth's Atmosphere").attr({fill:"#666666","font-size": 14*sfac[53]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[54],ny[54],"Earth's History").attr({fill:"#666666","font-size": 14*sfac[54]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[55],ny[55]-10,'Air Movement').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[55]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Air-Movement/#Air Movement", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[56],ny[56]-10,'Mineral Formation').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[56]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Mineral-Formation/#Mineral Formation", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[57],ny[57]-10,'Seafloor Spreading').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[57]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Seafloor-Spreading/#Seafloor Spreading", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[58],ny[58]-10,'World Climates').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[58]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/World-Climates/#World Climates", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[59],ny[59]-10,'The Universe').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[59]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Universe/#The Universe", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[60],ny[60],'Energy Conservation').attr({fill:"#666666","font-size": 14*sfac[60]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[61],ny[61]-10,'Galaxies').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[61]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Galaxies/#Galaxies", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[62],ny[62]-10,'Types of Rocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[62]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Types-of-Rocks/#Types of Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[63],ny[63]-10,'The Seafloor').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[63]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Seafloor/#The Seafloor", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[64],ny[64]-10,'Air Pollution').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[64]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Air-Pollution---Human-Actions-and-the-Atmosphere/#Air Pollution", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[65],ny[65]-10,'Ocean Life').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[65]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Ocean-Life/#Ocean Life", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[66],ny[66]-10,'Changing Weather').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[66]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Changing-Weather/#Changing Weather", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[67],ny[67]-10,'Weathering').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[67]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Weathering/#Weathering", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[68],ny[68]-10,'Soils').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[68]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Soils/#Soils", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[69],ny[69]-10,'The Precambrian').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[69]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Precambrian/#The Precambrian", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[70],ny[70]-10,'Weather and Atmospheric\nWater').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[70]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Weather-and-Atmospheric-Water/#Weather and Atmospheric Water", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[71],ny[71]-10,'Ocean Movements').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[71]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Ocean-Movements/#Ocean Movements", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[72],ny[72]-10,'Phanerozoic Earth History').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[72]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Phanerozoic-Earth-History/#Phanerozoic Earth History", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[73],ny[73],'Groundwater').attr({fill:"#666666","font-size": 14*sfac[73]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[74],ny[74]-10,"Earth's Surface").attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[74]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth’s-Surface/#Earth's Surface", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[75],ny[75]-10,'Storms').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[75]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Storms/#Storms", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[76],ny[76]-10,'Astronomy').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[76]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Astronomy", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[77],ny[77]-10,'Renewable Energy Resources').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[77]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Renewable-Energy-Resources/#Renewable Energy Resources", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[78],ny[78]-10,'Environmental Science').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[78]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Environmental Science", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[79],ny[79]-10,'Geology').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[79]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Geology", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[80],ny[80]-10,'Where in the World\nAre You?').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[80]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Where-in-the-World-Are-You?/#Where in the World Are You?", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[81],ny[81],'Rocks').attr({fill:"#666666","font-size": 14*sfac[81]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[82],ny[82]-10,'Oceanography').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[82]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Oceanography", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[83],ny[83]-10,"Earth's Moon").attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[83]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth’s-Moon/#Earth's Moon", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[84],ny[84],'What is Earth Science?').attr({fill:"#666666","font-size": 14*sfac[84]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[85],ny[85]-10,'The Sun').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[85]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Sun/#The Sun", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[86],ny[86]-10,'Outer Planets').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[86]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Outer-Planets/#Outer Planets", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[87],ny[87]-10,'Energy Resources').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[87]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Energy-Resources/#Energy Resources", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[88],ny[88]-10,'Volcanic Landforms and\nGeothermal Activity').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[88]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Volcanic-Landforms-and-Geothermal-Activity/#Volcanic Landforms and Geothermal Activity", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[89],ny[89]-10,'Pollution of the Land').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[89]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Pollution-of-the-Land/#Pollution of the Land", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[90],ny[90],'Ecosystems and Human\nPopulations').attr({fill:"#666666","font-size": 14*sfac[90]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[91],ny[91]-10,'Effects of Air Pollution').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[91]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Effects-of-Air-Pollution/#Effects of Air Pollution", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[92],ny[92],'Nature of Earthquakes').attr({fill:"#666666","font-size": 14*sfac[92]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[93],ny[93]-10,'Climate Change').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[93]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Climate-Change/#Climate Change", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[94],ny[94]-10,'Earth Science and its Branches').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[94]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Earth Science and its Branches", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[95],ny[95],'Stars, Galaxies, and the Universe').attr({fill:"#666666","font-size": 14*sfac[95]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[96],ny[96],'Volcanos').attr({fill:"#666666","font-size": 14*sfac[96]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[97],ny[97],'Protecting the Water\nSupply').attr({fill:"#666666","font-size": 14*sfac[97]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[98],ny[98]-10,'Volcanic Eruptions').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[98]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Volcanic-Eruptions/#Volcanic Eruptions", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[99],ny[99]-10,'Weather Forcasting').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[99]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Weather-Forecasting/#Weather Forcasting", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[100],ny[100],"Earth's Oceans").attr({fill:"#666666","font-size": 14*sfac[100]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[101],ny[101],"Evidence about Earth's Past").attr({fill:"#666666","font-size": 14*sfac[101]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[102],ny[102],"Earth's Fresh Water").attr({fill:"#666666","font-size": 14*sfac[102]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[103],ny[103]-10,'The Nature of Science').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[103]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/The-Nature-of-Science/#The Nature of Science", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[104],ny[104]-10,'Measuring and Predicting\nEarthquakes').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[104]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Measuring-and-Predicting-Earthquakes/#Measuring and Predicting Earthquakes", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[105],ny[105],"Studying Earth's Surface").attr({fill:"#666666","font-size": 14*sfac[105]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[106],ny[106]-10,'Overview of Earth Science').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[106]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Earth-Science-and-Its-Branches/#Overview of Earth Science", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[107],ny[107]-10,'Ecosystems').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[107]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Ecosystems---Ecosystems-and-Human-Populations/#Ecosystems", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[108],ny[108]-10,'Reducing Air Pollution').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[108]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Reducing-Air-Pollution/#Reducing Air Pollution", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[109],ny[109]-10,'Fossils').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[109]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Fossils/#Fossils", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[110],ny[110]-10,'Water on Earth').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[110]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Water-on-Earth/#Water on Earth", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.image('/media/js/conceptmap/icons/video.png',nx[110]-42,bb[110]-25,20,20); 
paper.image('/media/js/conceptmap/icons/chalkboard.png',nx[110]-18,bb[110]-25,20,20); 
paper.image('/media/js/conceptmap/icons/book.png',nx[110]+5,bb[110]-25,20,20); 
paper.image('/media/js/conceptmap/icons/exercise.png',nx[110]+25,bb[110]-25,20,20); 
t.toFront(); 
b[110]=paper.setFinish(); 

paper.setStart(); 
t=paper.text(nx[111],ny[111]-10,'Using Satellites and\nComputers').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[111]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Using-Satellites-and-Computers/#Using Satellites and Computers", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[112],ny[112]-10,'Non-renewable Energy\nResources').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[112]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Non-renewable-Energy-Resources/#Non-renewable Energy Resources", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[113],ny[113]-10,'Human Populations').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[113]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Human-Populations/#Human Populations", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[114],ny[114],'Weathering and Formation\nof Soil').attr({fill:"#666666","font-size": 14*sfac[114]});
tBox=t.getBBox(); 
bt[114]=ny[114]-(tBox.height/2+10*sfac[114]);
bb[114]=ny[114]+(tBox.height/2+10*sfac[114]);
...
paper.setStart(); 
t=paper.text(nx[115],ny[115],'Weather').attr({fill:"#666666","font-size": 14*sfac[115]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[116],ny[116]-10,'Sedimentary Rocks').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[116]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Sedimentary-Rocks/#Sedimentary Rocks", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[117],ny[117],"Earth's Minerals").attr({fill:"#666666","font-size": 14*sfac[117]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[118],ny[118],'Climate').attr({fill:"#666666","font-size": 14*sfac[118]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[119],ny[119]-10,'Erosion and Deposition\nby Gravity').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[119]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Erosion-and-Deposition-by-Gravity/#Erosion and Deposition by Gravity", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.setStart(); 
t=paper.text(nx[120],ny[120],'Human Actions and the Land').attr({fill:"#666666","font-size": 14*sfac[120]});
tBox=t.getBBox(); 
...
paper.setStart(); 
t=paper.text(nx[121],ny[121]-10,'Staying Safe in\nEarthquakes').attr({fill:"#000000", cursor: "pointer", "font-size": 14*sfac[121]});
t.mouseover(function (event) { 
    this.attr({fill: "#bf5600", cursor: "pointer", href: "/concept/Staying-Safe-in-Earthquakes/#Staying Safe in Earthquakes", target: "_top"});
}); 
t.mouseout(function (event) { 
    this.attr({cursor: "pointer", fill: "#000000"}); 
}); 
...
paper.image('/media/js/conceptmap/icons/video.png',nx[121]-42,bb[121]-25,20,20); 
paper.image('/media/js/conceptmap/icons/chalkboard.png',nx[121]-18,bb[121]-25,20,20); 
paper.image('/media/js/conceptmap/icons/book.png',nx[121]+5,bb[121]-25,20,20); 
paper.image('/media/js/conceptmap/icons/exercise.png',nx[121]+25,bb[121]-25,20,20); 
t.toFront(); 
...
paper.setStart(); 
s1='M '+nx[20]+' '+bb[20]+' L '+nx[20]+' '+ny[122]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[20],nx[122])+' '+ny[122]+' L '+Math.max(nx[20],nx[122])+' '+ny[122]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[23]+' '+bb[23]+' L '+nx[23]+' '+bt[25]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[24]+' '+bb[24]+' L '+nx[24]+' '+bt[84]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[26]+' '+bb[26]+' L '+nx[26]+' '+bt[60]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[27]+' '+bb[27]+' L '+nx[27]+' '+bt[61]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[30]+' '+bb[30]+' L '+nx[30]+' '+bt[28]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[35]+' '+bb[35]+' L '+nx[35]+' '+bt[53]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[36]+' '+bb[36]+' L '+nx[36]+' '+ny[123]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[36],nx[123])+' '+ny[123]+' L '+Math.max(nx[36],nx[123])+' '+ny[123]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[39]+' '+bb[39]+' L '+nx[39]+' '+bt[87]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[40]+' '+bb[40]+' L '+nx[40]+' '+ny[125]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[40],nx[125])+' '+ny[125]+' L '+Math.max(nx[40],nx[125])+' '+ny[125]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[42]+' '+bb[42]+' L '+nx[42]+' '+bt[40]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[47]+' '+bb[47]+' L '+nx[47]+' '+bt[69]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[50]+' '+bb[50]+' L '+nx[50]+' '+ny[122]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[50],nx[122])+' '+ny[122]+' L '+Math.max(nx[50],nx[122])+' '+ny[122]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[51]+' '+bb[51]+' L '+nx[51]+' '+bt[64]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[53]+' '+bb[53]+' L '+nx[53]+' '+bt[33]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[54]+' '+bb[54]+' L '+nx[54]+' '+bt[47]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[55]+' '+bb[55]+' L '+nx[55]+' '+ny[122]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[55],nx[122])+' '+ny[122]+' L '+Math.max(nx[55],nx[122])+' '+ny[122]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[57]+' '+bb[57]+' L '+nx[57]+' '+ny[123]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[57],nx[123])+' '+ny[123]+' L '+Math.max(nx[57],nx[123])+' '+ny[123]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[61]+' '+bb[61]+' L '+nx[61]+' '+bt[59]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[67]+' '+bb[67]+' L '+nx[67]+' '+bt[45]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[69]+' '+bb[69]+' L '+nx[69]+' '+bt[72]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[70]+' '+bb[70]+' L '+nx[70]+' '+bt[75]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[76]+' '+bb[76]+' L '+nx[76]+' '+bt[31]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[78]+' '+bb[78]+' L '+nx[78]+' '+bt[90]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[81]+' '+bb[81]+' L '+nx[81]+' '+bt[62]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[83]+' '+bb[83]+' L '+nx[83]+' '+ny[124]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[83],nx[124])+' '+ny[124]+' L '+Math.max(nx[83],nx[124])+' '+ny[124]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[84]+' '+bb[84]+' L '+nx[84]+' '+bt[103]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[85]+' '+bb[85]+' L '+nx[85]+' '+ny[124]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[85],nx[124])+' '+ny[124]+' L '+Math.max(nx[85],nx[124])+' '+ny[124]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[90]+' '+bb[90]+' L '+nx[90]+' '+bt[107]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[94]+' '+bb[94]+' L '+nx[94]+' '+bt[106]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[95]+' '+bb[95]+' L '+nx[95]+' '+bt[27]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
lineNodes[96]=[101,109]; 

paper.setStart(); 
s1='M '+nx[102]+' '+bb[102]+' L '+nx[102]+' '+bt[110]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[97]=paper.setFinish(); 
lineNodes[97]=[102,110] ; 

paper.setStart(); 
s1='M '+nx[103]+' '+bb[103]+' L '+nx[103]+' '+bt[94]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
lineNodes[100]=[105,80]; 

paper.setStart(); 
mid=bb[106]+(bt[79]-bb[106])/2; 
...
lineNodes[106]=[106,76]; 

paper.setStart(); 
mid=bb[107]+(bt[113]-bb[107])/2; 
hleft = nx[113]; 
hright = nx[107]; 
s1='M '+hleft+' '+mid+' L '+hright+' '+mid; 
h=paper.path(s1); 
...
lineNodes[108]=[107,49]; 

paper.setStart(); 
s1='M '+nx[109]+' '+bb[109]+' L '+nx[109]+' '+ny[125]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+Math.min(nx[109],nx[125])+' '+ny[125]+' L '+Math.max(nx[109],nx[125])+' '+ny[125]; 
h=paper.path(s2); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[109]=paper.setFinish(); 
lineNodes[109]=[109,125]; 

paper.setStart(); 
mid=bb[110]+(bt[29]-bb[110])/2; 
hleft = nx[73]; 
hright = nx[110]; 
s1='M '+hleft+' '+mid+' L '+hright+' '+mid; 
h=paper.path(s1); 
...
lineNodes[111]=[110,29]; 

paper.setStart(); 
mid=bb[49]+(bt[120]-bb[49])/2; 
s2='M '+nx[113]+' '+bb[113]+' L '+nx[113]+' '+mid; 
v1=paper.path(s2); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
lineNodes[115]=[113,51]; 

paper.setStart(); 
mid=bb[114]+(bt[67]-bb[114])/2; 
hleft = nx[67]; 
hright = nx[114]; 
s1='M '+hleft+' '+mid+' L '+hright+' '+mid; 
h=paper.path(s1); 
h.attr({stroke:"#333333", "stroke-width": "3"}); 
s2='M '+nx[114]+' '+bb[114]+' L '+nx[114]+' '+mid; 
v1=paper.path(s2); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
lineNodes[117]=[114,68]; 

paper.setStart(); 
mid=bb[115]+(bt[99]-bb[115])/2; 
...
lineNodes[120]=[115,70]; 

paper.setStart(); 
s1='M '+nx[117]+' '+bb[117]+' L '+nx[117]+' '+bt[8]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
...
paper.setStart(); 
s1='M '+nx[118]+' '+bb[118]+' L '+nx[118]+' '+bt[19]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[122]=paper.setFinish(); 
lineNodes[122]=[118,19] ; 

paper.setStart(); 
mid=bb[120]+(bt[46]-bb[120])/2; 
hleft = nx[89]; 
hright = nx[120]; 
s1='M '+hleft+' '+mid+' L '+hright+' '+mid; 
h=paper.path(s1); 
...
lineNodes[124]=[120,46]; 

paper.setStart(); 
mid=bb[122]+(bt[115]-bb[122])/2; 
hleft = nx[118]; 
hright = nx[122]; 
s1='M '+hleft+' '+mid+' L '+hright+' '+mid; 
h=paper.path(s1); 
...
lineNodes[126]=[122,115]; 

paper.setStart(); 
s1='M '+nx[123]+' '+bb[123]+' L '+nx[123]+' '+bt[16]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[127]=paper.setFinish(); 
lineNodes[127]=[123,16] ; 

paper.setStart(); 
s1='M '+nx[124]+' '+bb[124]+' L '+nx[124]+' '+bt[37]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[128]=paper.setFinish(); 
lineNodes[128]=[124,37] ; 

paper.setStart(); 
s1='M '+nx[125]+' '+bb[125]+' L '+nx[125]+' '+bt[54]; 
v1=paper.path(s1); 
v1.attr({stroke:"#333333", "stroke-width": "3"}); 
lines[129]=paper.setFinish(); 
lineNodes[129]=[125,54] ; 
