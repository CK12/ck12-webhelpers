...
FIRSTNAME_CHARS_DISALLOWED = _( '" and @ are not allowed in firstname')
LASTNAME_CHARS_DISALLOWED = _( '" and @ are not allowed in lastname')
...
ACCOUNT_FULLNAME_EMPTY = _('Please enter your full name')
...
ACCOUNT_PASSWORD_EMPTY_2 = _('Please enter a password')
...
ACCOUNT_DOB_EMPTY = _('Please enter your birthday')
ACCOUNT_DOB_BEFORE_TODAY = _('Date of birth can not be from future')
ACCOUNT_DOB_BAD_FORMAT = _('Please enter the date in the form mm/dd/yyyy')
ACCOUNT_UNDERAGE_INVALID_ROLE = _('An under 13 user can not have a teacher role')
...
##################################
RESET_PASSWORD_EMPTY= _("Please enter new password")
RESET_CONFIRM_PASSWORD_EMPTY= _("Please enter confirm password same as password")
RESET_PASSWORD_MATCH= _("Passwords do not match. Please enter the same password as above")

##################################
# Signin Messages
##################################
SIGNIN_USERNAME_EMPTY= _("Please enter a username/email")
SIGNIN_PASSWORD_EMPTY= _("Please enter the correct password")
