        ...
        try:
            ...
            for row in reader:
                ...
                try:
                    ...
                    if self.verbose:
                        log.debug('uploadStudents: %s, %s, %s, %s, %s, %s, %s, %s' % (sid, firstName, lastName, birthday, email, login, password, message))
                finally:
                    if sid:
...
if __name__ == "__main__":
    ...
    prefix = None
    url = 'mysql://dbadmin:D-coD#43@localhost:3306/auth?charset=utf8'
...
""")
    ...
    if not prefix:
        ...
        log.info('uploadStudents: Missing prefix.')
        exit()
