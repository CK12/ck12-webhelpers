...
def start(app, url):
    ...
    for eachPublishedBook in publishedBooksIDs:
        ...
        printToLog('%d. Generating ePub - artifactID: %s, name: %s' %(count, eachPublishedBook, artifact.name))
        #renderPDFEndPoint = 'http://localhost/flx/render/epubnoauth/%s/nocache' %(eachPublishedBook)
