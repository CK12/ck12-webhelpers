...
public class Utils {
    ...
    static String makeCanonicalString(String method,
                                      String bucket,
                                      String key,
    ...
    static String makeCanonicalString(String method,
        ...
        for (Iterator<String> i = interestingHeaders.keySet().iterator(); i
                .hasNext();) {
            String headerKey = (String) i.next();
            if (headerKey.startsWith(AMAZON_HEADER_PREFIX)) {
                buf.append(headerKey).append(':').append(interestingHeaders
                        .get(headerKey));
            } else {
     ...
     */
    static String encode(String awsSecretAccessKey,
        ...
        SecretKeySpec signingKey =
                new SecretKeySpec(awsSecretAccessKey.getBytes(),
                                  HMAC_SHA1_ALGORITHM);
    ...
    static Map<String, String> paramsForListOptions(String prefix,
        ...
        if (prefix != null) argParams.put("prefix", urlencode(prefix));
        if (marker != null) argParams.put("marker", urlencode(marker));
        if (delimiter != null)
    ...
    public static String convertPathArgsHashToString(Map<String, String> pathArgs) {
        ...
        if (pathArgs != null) {
            for (Iterator<String> argumentIterator =
                    pathArgs.keySet().iterator(); argumentIterator.hasNext();) {
    ...
    static boolean validateBucketName(String bucketName,
        ...
        if (callingFormat == CallingFormat.getPathCallingFormat()) {
            ...
            final String BUCKET_NAME_REGEX =
