    ...
    public ListAllMyBucketsResponse(HttpURLConnection connection)
        ...
        if (connection.getResponseCode() < 400) {
            try {
                ...
                throw new RuntimeException("Unexpected error parsing ListAllMyBuckets xml",
                                           e);
            }
        }
    }
    ...
    static class ListAllMyBucketsHandler
        ...
        public void endElement(String uri, String name, String qName) {
            if (name.equals("Bucket")) {
                ...
                try {
                    this.currBucket.creationDate =
                            this.iso8601Parser.parse(this.currText.toString());
                } catch (ParseException e) {
                    throw new RuntimeException("Unexpected date format in list bucket output",
                                               e);
                }
            }
            this.currText = new StringBuffer();
